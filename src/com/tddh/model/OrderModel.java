...
public class OrderModel implements Serializable {
	...
	private Integer order_submit_state;// customer submit the order 0 false 1
										// true
	private Integer order_state;// order state 0 to be shipped 1 shipped 2 be
	// receipt
	...
	public String toString() {
		return "{order_id:" + order_id + ", order_user_id:" + order_user_id + ", order_create_time:" + order_create_time
				...
				+ order_state + ", express_id:" + express_id + ", express_number:" + express_number + "}";
	}
